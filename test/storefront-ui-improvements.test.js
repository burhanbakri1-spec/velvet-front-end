...
test('header main site logo uses uploaded artwork without CSS plate/shadow', () => {
  ...
  assert.match(css, /\.logo--velvet-badge \.logo__img--managed-site[\s\S]{0,220}?max-width:\s*176px/);
  assert.match(css, /\.logo--velvet-badge \.logo__img--managed-site[\s\S]{0,220}?max-height:\s*67px/);
