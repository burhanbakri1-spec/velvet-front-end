export const aboutSections = [
  {
    ...
    paragraphs: ['VELVET begins with a simple belief: imagination deserves room to run. We make bright, tactile worlds that invite children to invent the rules, change the story, and start again.', 'Our teams pair curious thinking with careful craft. Every color, character, and click is shaped to feel joyful on day one and still surprising on day one hundred.'],
    paragraphsAr: ['تبدأ VELVET من إيمان بسيط: الخيال يستحق مساحة ينطلق فيها. نصنع عوالم مبهجة وملموسة تدعو الأطفال إلى ابتكار القواعد وتغيير القصة والبدء من جديد.', 'تجمع فرقنا بين الفضول والحرفة الدقيقة. نصمم كل لون وشخصية وتفصيل ليبقى ممتعاً ومفاجئاً مع مرور الوقت.'],
  },
  {
    ...
    paragraphs: ['Designers, storytellers, engineers, and play-testers share one table at VELVET. We work in small, open teams where an unfinished thought can become the beginning of an entirely new world.', 'We value generous feedback, bold experiments, and people who stay curious. The result is a culture with high standards, plenty of laughter, and real ownership from sketch to shelf.'],
    paragraphsAr: ['يجتمع المصممون ورواة القصص والمهندسون ومختبرو الألعاب حول طاولة واحدة في VELVET. نعمل ضمن فرق صغيرة ومنفتحة، حيث يمكن لفكرة غير مكتملة أن تصبح بداية عالم جديد.', 'نقدّر الملاحظات الصادقة والتجارب الجريئة والفضول المستمر. والنتيجة ثقافة ذات معايير عالية وروح مرحة ومسؤولية حقيقية من الفكرة إلى المنتج.'],
  },
  {
  ...
  },
  {
    ...
    paragraphs: ['Play is a universal language. We support community partners who create safe, welcoming places for children to learn, make friends, and express themselves.', 'Inside VELVET, we keep widening the circle too. Different backgrounds and perspectives help us build richer worlds—and a company where more people can do their best work.'],
    paragraphsAr: ['اللعب لغة عالمية. ندعم شركاء المجتمع الذين يصنعون أماكن آمنة ومرحبة يتعلم فيها الأطفال ويكوّنون الصداقات ويعبّرون عن أنفسهم.', 'وفي VELVET نوسّع الدائرة باستمرار. تساعدنا الخلفيات ووجهات النظر المختلفة على بناء عوالم أغنى وشركة يستطيع فيها مزيد من الأشخاص تقديم أفضل ما لديهم.'],
  },
];
